        ...
        <div  className='flex items-center w-[900px] gap-6'>
            <div className='flex flex-col gap-6 w-[50%]'>
                ...
                <div className='flex items-center gap-4'>
                    <button className='bg-yellow-400 p-4 rounded-lg font-semibold'>Explore meals</button>
                    <button className='bg-gray-800 p-4 rounded-lg font-semibold'>Saved meals</button>
                </div>
            </div>
